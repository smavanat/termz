# Introduction
This is a work in progress toy implementation of a terminal emulator. I am using it as a learning project to improve my understanding of terminals, working with system calls, and working with Zig. This project is currently only for Linux, but should work with any shell. I plan to expand the functionality in the future
